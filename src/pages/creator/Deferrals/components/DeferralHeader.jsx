...
const headerClassName = "rounded-[28px] border border-[rgba(214,189,152,0.18)] bg-[linear-gradient(135deg,#fffdf8_0%,#f7f3ea_100%)] p-5 shadow-[0_16px_40px_rgba(15,23,42,0.05)]";
...
const secondaryButtonClassName = "h-11 rounded-xl border-[rgba(214,189,152,0.22)] bg-white px-4 text-(--color-text-medium) shadow-none hover:border-[rgba(214,189,152,0.32)] hover:bg-[#faf7f2] hover:text-(--color-text-dark)";
